...
rm -rf "/D/Praca/HydraXLStanyZalegajace/.publish/release-win-86/"

dotnet build "XLHydraZaEEdycjaBase.csproj" -c Release -o "/D/Praca/HydraXLStanyZalegajace/.publish/release-win-86"